...
public class SlideShow : MonoBehaviour
{
	...
	public string myPath = @"C:\Users\MFHabibie\Documents\New Unity Project\Assets\Animate\Video\Ending"; // directory where all the *.jpg files are that need to be animated
